...
iniciarSesion.addEventListener("click", () => {
  if (usuario.value == usuarioBD && contrasenia.value == contraseniaBD) {
    ...
    // Guardar los datos del usuario en el almacenamiento local JSON
...
//Usuario ya cargado y almacenado en la base de datos local
let usuarioBD = "rodrigo"
let contraseniaBD = "rodrigo11"
...
//Agrego unos sweet alert para finalizar la compra
document.getElementById("finalizarCompra").addEventListener("click", function () {
  Swal.fire({
    title: 'Procesando...',
    showConfirmButton: false,
    allowOutsideClick: false,
    timer: 1500 // Simulamos un retraso de 1,5 seg
  });
